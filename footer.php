        ...
        <div class="bot">
            <div class="row">
                <div class="span2">
                    ...
                    <ul >
                        <li><a href="donate.php"style="color:#FFF; text-decoration:none;">Donate Us</a></li>
                        <li><a href="registration.php"style="color:#FFF; text-decoration:none;">Registration</a></li>
                        <li><a href="contact_us.php"style="color:#FFF; text-decoration:none;">Collborate with us</a></li>
                        <li><a href="magzine.php"style="color:#FFF; text-decoration:none;">Aakaar</a></li>
                        <li><a href="certificate.php"style="color:#FFF; text-decoration:none;">Certificate</a></li>
                    </ul>
                </div>
                <div class="span3">
